...
const buyDataSecure = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
        const { clientRequestId, network, phoneNumber, amount, humanRef, requestID, useReward, isRecharge, variationCode, plan, } = req.body;
        ...
        yield admin.firestore().runTransaction((t) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const bonusPercent = (_c = bonusDoc.data()) === null || _c === void 0 ? void 0 : _c.data;

...
const jambServices = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        yield (0, auth_1.checkAuth)(req);
        const response = yield axios_1.default.get("https://sandbox.vtpass.com/api/service-variations", {

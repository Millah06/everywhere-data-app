...
const verifyMerchant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    try {
        ...
        const response = yield axios_1.default.post("https://vtpass.com/api/merchant-verify", {
            serviceID: serviceID,
...
exports.default = verifyMerchant;

...
const purchaseSecureTv = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
        const { clientRequestId, phoneNumber, amount, humanRef, requestID, useReward, isRecharge, variationCode, plan, serviceID, subscriptionType, smartCard } = req.body;
        if (!phoneNumber || !amount
            || !requestID || !clientRequestId || !variationCode || !plan || !serviceID || !subscriptionType) {
        ...
        const vendorResponse = yield axios_1.default.post("https://vtpass.com/api/pay", {
        ...
        yield admin.firestore().runTransaction((t) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const calculation = (0, calculateTransaction_1.calculateTransaction)({
                ...
                useReward,
                isRecharge,
                bonusPercent: (_c = bonusDoc.data()) === null || _c === void 0 ? void 0 : _c.data,
            });
...
exports.default = purchaseSecureTv;

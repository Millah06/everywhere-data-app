...
const sendRechargeCard = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        const response = yield axios_1.default.post("https://vtunaija.com.ng/api/rechargepin/", {
            network: network,
...
exports.default = sendRechargeCard;
